...
@section('admin::title','ELV Solutions')
@section('admin::content')
<link rel="stylesheet" href="{{asset('css/admin/solution/elv-solution.css')}}">
<style>
.note
{
    text-align: center;
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                          <div class="breadcomb-wp">
                                           <div class="breadcomb-ctn">
                                              <h2> ELV Solutions </h2> <br>

                                              <div class="add-product">
                                               <a data-toggle="modal" data-target=".bd-example-modal-lg" id="create-list" href=""> Add </a>
                                              </div>
                                           </div>
                                          </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="product-status-wrap">
                                <h4 style="color:green;">List of Solutions ( ELV )</h4>
                                ...
                                <table>
                                    ...
                                    <tr><?php $i++; ?>
                                        <td width="3%">{{$i}}</td>
                                        <td width="10%"><img src="{{asset('assets/img/solutions/'.$solution->main_image)}}" alt="" /></td>
                                        <td width="10%" style="color:orange;"> {{$solution->name}}</td>
                                        ...
                                        @endif
                                        <td>
                                            <button data-toggle="modal" data-target=".edit-modal-lg" data-toggle="tooltip" onclick="updateSolution('{{$solution->id}}');" title="Edit" class="pd-setting-ed"><i class="fas fa-edit" aria-hidden="true"></i></button>

                                            <!-- <a href="{{url('boh/delete_solution',$solution->id)}}"> -->
         ...
         <div class="modal-dialog modal-lg"></p> 
            <div class="modal-content">
                <div class="modal-header note">
                        ...
                        <h2 class="modal-title" id="exampleModalLongTitle"> Create New ELV Solution</h2>
                    
                </div>
                    <form action="{{url('boh/add_solution')}}" method="post"  enctype="multipart/form-data" >
                        @csrf
         ...
         <div class="modal-dialog modal-lg"></p> 
            <div class="modal-content">
                <div class="modal-header note">
                    ...
                    <form action="{{url('boh/update_solution')}}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="modal-body">
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <input type="hidden" name="id" id="edit_s_id">
                                                    ...
                                                    <input type="text" id="edit_name" name="name" class="form-control" placeholder="Title" value="" />
                                                </div>
                                                    <label class="">
                                                        <img id="edit_main_image" src="http://placehold.it/750x500" >
                                                        <input id="edit_main_imagepic" name="main_image" onchange="edit_main_imageURL(this);" type="file" >
                                                    </label>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <label class="">
                                        ...
                                        <input id="edit_image_1pic" name="image_1" onchange="edit_image_1URL(this);" type="file" >
                                    </label>
                                    </div>
                                    <div class="col-md-3">
                                    <label class="">
                                        <img id="edit_image_2" src="http://placehold.it/500x300" >
                                        <input id="edit_image_2pic" name="image_2" onchange="edit_image_2URL(this);" type="file" >
                                    </label>
                                    </div>
                                    <div class="col-md-3">
                                    <label class="">
                                        <img id="edit_image_3" src="http://placehold.it/500x300" >
                                        <input id="edit_image_3pic" name="image_3" onchange="edit_image_3URL(this);" type="file" >
                                    </label>
                                    </div>
                                    <div class="col-md-3">
                                    <label class="">
                                        <img id="edit_image_4" src="http://placehold.it/500x300" >
                                        <input id="edit_image_4pic" name="image_4" onchange="edit_image_4URL(this);" type="file" >
                                    </label>
                                    </div>
                                </div>
...
<script src="{{asset('js/admin/solution/elv-solution.js')}}"></script>
    <script>
 ...
 // <!-- Start Update modal -->
    function updateSolution(id) {
        ...
        $.each(list_array, function (index ,list_arr) {
            ...
            var cover_image_e = '../assets/img/solutions/'+data.cover_image;
  ...
  function edit_image_4URL(input) {
    ...
    function deleteSolution(id){
        if (confirm('Are you sure want to delete this Solution!')) {
            $.get( "{{url('boh/delete_solution')}}",{ id } )
            .done(function( data ) {
                location.reload();
