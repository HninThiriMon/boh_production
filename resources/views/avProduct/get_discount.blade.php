            ...
            @csrf
                    <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" value="{{$avProduct->product_name}}" required="required" disabled/>
                                <input type="hidden" name="product" value="{{$avProduct->product_name}}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name">
                                    Name *</label>
                                <input type="text" name="name" class="form-control" id="full_name" placeholder="Enter name" required="required" />
                            </div>
                        </div>   
                        ...
                        <div class="col-md-6">
                                ...
                                <label for="city">brand *</label>
                                    <input type="text" name="brand" class="form-control" value="{{$avProduct->brand_name}}" required="required" disabled/>
                                    <input type="hidden" name="brand" value="{{$avProduct->brand_name}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="city">Quantity </label>
                                    <input type="text" name="quantity" class="form-control" id="city" placeholder="Enter city" required="required" />
                                </div>
                            </div>

                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="name"> Inquiry Details * </label>
