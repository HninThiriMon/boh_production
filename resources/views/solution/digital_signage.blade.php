...
<style>
    .hero {
    min-height: 80%;
    background: url("{{asset('assets/img/solutions/'.$solution->cover_image)}}") no-repeat fixed;
    background-size: 100%;
    position: relative;
    padding-bottom: 2%;
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-8">
      <img src="{{asset('assets/img/solutions/'.$solution->main_image)}}" width="700" height="500" >
    </div>
    ...
    <hr>
    <a href="{{url('About_us')}}"> <button type="button"  class="btn btn-dark"> Help me with this System </button> </a>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-6 mb-4">
      <a href="#">
            <img class="fluid" src="{{asset('assets/img/solutions/'.$solution->image_1)}}" alt="">
          </a>
    </div>

    <div class="col-md-3 col-sm-6 mb-4">
      <a href="#">
            <img class="fluid" src="{{asset('assets/img/solutions/'.$solution->image_2)}}" alt="">
          </a>
    </div>

    <div class="col-md-3 col-sm-6 mb-4">
      <a href="#">
            <img class="fluid" src="{{asset('assets/img/solutions/'.$solution->image_3)}}" alt="">
          </a>
    </div>

    <div class="col-md-3 col-sm-6 mb-4">
      <a href="#">
            <img class="fluid" src="{{asset('assets/img/solutions/'.$solution->image_4)}}"  alt="">
          </a>
    </div>
...
<div class="container">
    <div class="row">
		<div class="well">
            ...
            <a href="{{url('each_elv_project/'. $ElvProject->id )}}" target="_blank" class="list-group-item "> <br>
            <?php
                $project_images = json_decode($ElvProject->project_images, true);
                ?>
                    <div class="media col-md-3">
                        <figure class="pull-left">
                        <img class="media-object img-rounded img-responsive"  src="{{asset('assets/img/ElvProjects/'.$project_images[0])}}" alt="placehold.it/350x250" >
                        </figure>
                    </div>
                    <div class="col-md-6">
                        <h4 class="list-group-item-heading"> {{$ElvProject->company_name}} </h4> <br>
                        <p class="list-group-item-text"> {{ \Illuminate\Support\Str::limit($ElvProject->description, 250, $end='...') }}
                        </p>
                    </div>
